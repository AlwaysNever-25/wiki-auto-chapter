...
if not SEARCH[1]:
    ...
    PARAMS_4 = {
            ...
            "bot": "yes",
            "format": "json",
            "text": "{{ChapterKai \n|name         = \n|Kana         = \n|Romaji       = \n|PAGENAME     = \n|imagepath    = Chapter %s cover.png\n|Color #1     = #FF9A00\n|Release Date = %s  (Weekly Young Jump 2024 #%d/ Mangaplus)\n|Volume       = 16\n|Arc          = Toward the Stars and Dreams\n}}\n{{Nihongo|'''Chapter %s'''||}} is the %s chapter of ''[[Oshi no Ko (manga)|Oshi no Ko]]'' manga series. It is written by [[Aka Akasaka]] and illustrated by [[Mengo Yokoyari]]. It will be released in ''Weekly Young Jump'' on %s.\n== Summary ==\n\n== Characters ==\n\n== Trivia ==\n\n== References ==\n{{References}}\n\n== Navigation ==\n{{MangaNavigation}}" % (chapter_num+1, chapter_date, magazine_number, chapter_num+1, chapter_ord, chapter_date),
            "token": CSRF_TOKEN
        }
